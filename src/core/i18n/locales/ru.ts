...
export const ruMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  chats: {
    ...
    settingsDrawer: { title: "Настройки чата", subtitle: "Управление предпочтениями разговора" },
  },
  ...
  developer: {
    ...
    onboarding: { title: "Введение", resetTours: "Сбросить все туры", resetToursDesc: "Очищает состояние просмотра каждого тура, чтобы они воспроизвелись при следующем посещении." },
    benchmarks: {
  ...
  tour: {
    stepCounter: "Шаг {{current}} из {{total}}", skipTour: "Пропустить тур", next: "Далее", gotIt: "Понятно",
    appShell: {
      chats: { title: "Здесь живут ваши чаты", body: "Все ваши личные разговоры с персонажами находятся здесь. Возвращайтесь в любое время, и мы сохраним ваше место." },
      groups: { title: "Групповые чаты", body: "Соберите нескольких персонажей в одной комнате и наблюдайте, как они общаются, или присоединяйтесь сами, когда захотите." },
      discover: { title: "Найдите новых персонажей", body: "Просматривайте то, чем поделилось сообщество, и забирайте любого приглянувшегося персонажа. Новые фавориты в одно касание." },
      library: { title: "Ваша личная библиотека", body: "Всё, что вы создали или сохранили, живёт здесь: персонажи, персоны, промпты — всё. Считайте это вашим хранилищем." },
      settings: { title: "Настройте под себя", body: "Меняйте провайдеров, выбирайте модели, настраивайте внешний вид приложения. Практически всё регулируется в настройках." },
      search: { title: "Найдите что угодно быстро", body: "Ищете конкретный чат или персонажа? Ищите по всему отсюда. Никакого копания." },
      create: { title: "И наконец, создавайте!", body: "Нажмите плюс, когда придёт вдохновение. Создайте нового персонажа, персону или начните что-то с нуля." },
    },
    chatDetail: {
      chatTitle: { title: "Настройки для каждого чата", body: "Нажмите на имя персонажа вверху, чтобы открыть настройки именно для этого чата. Разные персоны, раскладки и модели для каждого разговора." },
      chatMemory: { title: "Что они помнят", body: "Значок мозга показывает, что ваш персонаж помнит о ваших разговорах. Нажмите для просмотра, редактирования или очистки воспоминаний." },
      chatSearch: { title: "Найдите ту самую строку", body: "Поиск только в этом разговоре. Отлично подходит для поиска детали 200 сообщений назад без бесконечной прокрутки." },
      chatLorebook: { title: "Записи лорбука", body: "Дополнительные факты, мироустройство и контекст, которые вставляются в промпт при появлении определённых ключевых слов. Шпаргалка вашего персонажа." },
      chatPlus: { title: "Прикрепляйте вложения", body: "Добавьте изображения или откройте меню дополнений. Всё, что вы прикрепите, отправится вместе с вашим следующим сообщением." },
      chatComposer: { title: "Ваше сообщение, ваш ход", body: "Пишите здесь. Enter отправляет, Shift+Enter — новая строка. Совет: долгое нажатие на любое сообщение для редактирования, ветвления или удаления." },
      chatSend: { title: "Одна кнопка, четыре функции", body: "Кнопка отправки меняет свою функцию в зависимости от ситуации:" },
    },
    postFirstMessage: {
      chatRegenerate: { title: "Не нравится? Перегенерируйте", body: "Нажмите значок обновления, чтобы получить совершенно новый ответ от персонажа. Каждая перегенерация сохраняется как вариант." },
      chatVariants: { title: "Листайте между вариантами", body: "После перегенерации вы увидите счётчик вариантов под сообщением. Проведите влево или вправо по пузырю сообщения, чтобы просмотреть все варианты ответов." },
      chatLongPress: { title: "Здесь скрыто ещё кое-что", body: "Долгое нажатие на любое сообщение для редактирования, копирования, ветвления, закрепления, удаления или отката разговора. На десктопе работает правый клик." },
    },
    sendButton: {
      continue: { label: "Продолжить", desc: "Поле ввода пусто. Нажмите, чтобы персонаж продолжил говорить." },
      send: { label: "Отправить", desc: "Вы набрали или прикрепили что-то. Нажмите для отправки." },
      sending: { label: "Отправка", desc: "Ответ в пути. Кнопка заблокирована." },
      stop: { label: "Стоп", desc: "Нажмите для отмены во время ответа, если передумаете." },
    },
  },

  sessionAdvanced: {
    title: "Параметры сеанса", subtitle: "Переопределить настройки модели для этого разговора",
    goBack: "Назад", support: "Поддержка", reset: "Сбросить", save: "Сохранить",
    noSessionWarning: "Откройте сеанс чата, чтобы настроить параметры для конкретного сеанса.",
    overrideDefaults: "Переопределить по умолчанию", overrideDefaultsDesc: "Настройте параметры только для этого разговора",
    loadingContextInfo: "Загрузка информации о контексте...",
    sampling: { title: "Сэмплирование", temperature: "Temperature", temperatureDesc: "Контролирует случайность. Ниже = более детерминированно, выше = более креативно.", temperaturePrecise: "Точно", temperatureCreative: "Креативно", topP: "Top P", topPDesc: "Nucleus sampling. Ограничивает токены кумулятивной вероятностью.", topPFocused: "Фокусировано", topPDiverse: "Разнообразно", topK: "Top K", topKDesc: "Ограничивает сэмплирование top K наиболее вероятными токенами." },
    outputPenalties: { title: "Вывод и штрафы", maxOutputTokens: "Макс. токенов вывода", maxOutputTokensDesc: "Максимальная длина ответа. Auto позволяет модели решить.", auto: "Auto", custom: "Пользовательский", frequencyPenalty: "Штраф за частоту", frequencyPenaltyDesc: "Уменьшает повторение последовательностей токенов.", frequencyPenaltyRepeat: "Повтор", frequencyPenaltyVary: "Разнообразие", presencePenalty: "Штраф за присутствие", presencePenaltyDesc: "Поощряет исследование новых тем.", presencePenaltyRepeat: "Повтор", presencePenaltyExplore: "Исследование" },
    performance: { title: "Производительность", gpuLayers: "GPU Layers", gpuLayersDesc: "Слои, выгруженные на GPU. 0 = только CPU.", threads: "Threads", threadsDesc: "Потоки CPU для инференса.", batchThreads: "Batch Threads", batchThreadsDesc: "Потоки CPU для пакетной обработки.", batchSize: "Batch Size", batchSizeDesc: "Размер блока обработки промпта.", contextLength: "Длина контекста", contextLengthDesc: "Переопределить размер окна контекста.", flashAttention: "Flash Attention", flashAttentionDesc: "Оптимизация памяти GPU.", enabled: "Включено", disabled: "Отключено" },
    samplingMemory: { title: "Сэмплирование и память", minP: "Min P", minPDesc: "Минимальный порог вероятности.", typicalP: "Typical P", typicalPDesc: "Порог типичного сэмплирования.", seed: "Seed", seedDesc: "Случайный seed. Оставьте пустым для случайного.", ropeBase: "RoPE Base", ropeBaseDesc: "Переопределение базы частоты.", ropeScale: "RoPE Scale", ropeScaleDesc: "Переопределение масштаба частоты.", kvCacheType: "KV Cache Type", kvCacheTypeDesc: "Квантизация KV cache для экономии VRAM.", offloadKqv: "Offload KQV", offloadKqvDesc: "KV cache и операции KQV на GPU.", on: "Вкл", off: "Выкл", samplerProfile: "Профиль сэмплера", samplerProfileDesc: "Настроенные значения по умолчанию для стабильности или рассуждений.", balanced: "Сбалансированный", creative: "Креативный", stable: "Стабильный", reasoning: "Рассуждение" },
    systemInfo: { title: "Системная информация", maxContext: "Макс. контекст", recommended: "Рекомендуемый", availableRam: "Доступная RAM", availableVram: "Доступная VRAM", modelSize: "Размер модели" },
  },

  exportMenu: {
    title: "Формат экспорта", selectFormat: "Выберите формат", uscTitle: "Unified System Card",
    formats: { uscPrompt: "Портативный экспорт USC для шаблонов промптов.", uscLorebook: "Портативный экспорт USC для лорбуков.", uscModel: "Портативный экспорт USC для профилей моделей.", uscChatTemplate: "Портативный экспорт USC для шаблонов чатов.", legacyPromptJson: "Legacy Prompt JSON", legacyPromptJsonDesc: "Текущий формат внешнего пакета промптов.", lorebookJson: "Lorebook JSON", lorebookJsonDesc: "Текущий формат экспорта лорбуков.", modelJson: "Model JSON", modelJsonDesc: "Безопасный JSON профиля модели без учётных данных.", chatTemplateJson: "Chat Template JSON", chatTemplateJsonDesc: "Нативный формат экспорта шаблонов чатов." },
  },

  designReference: {
    title: "Референсы дизайна", description: "Загрузите несколько чётких референсных изображений и одно каноническое визуальное описание.",
    ...
    addReferences: "Добавить референсы", visualDescription: "Визуальное описание", draftWithAi: "Черновик с AI",
    referenceImages: "Референсные изображения", imageAlt: "Референс дизайна {{index}}", loading: "Загрузка...",
    removeAria: "Удалить референс дизайна", noImages: "Референсных изображений пока нет",
    ...
    draftMenuTitle: "AI-черновик дизайна", draftMenuDesc: "Черновик создан {{model}} на основе текущего аватара и референсных изображений.",
    draftMenuNoWriter: "Добавьте совместимую модель scene writer перед использованием этого помощника.",
    regenerate: "Перегенерировать", useThis: "Использовать",
  },

  samplerOrder: {
    title: "Порядок сэмплера", description: "Перетаскивайте этапы для изменения порядка. Выполняются сверху вниз.",
    reset: "Сбросить", resetAria: "Сбросить порядок сэмплера на значения по умолчанию",
    stages: {
      penalties: { label: "Штрафы", desc: "Применить штрафы за частоту и присутствие перед фильтрацией." },
      grammar: { label: "Грамматика", desc: "Ограничить токены при активной грамматике нативного шаблона чата." },
      topK: { label: "Top K", desc: "Сократить пул кандидатов до сильнейших токенов." },
      topP: { label: "Top P", desc: "Применить ядерную фильтрацию к оставшемуся распределению." },
      minP: { label: "Min P", desc: "Отбросить маловероятные хвостовые токены с минимальным порогом." },
      typical: { label: "Typical P", desc: "Предпочитать статистически типичные токены в текущем распределении." },
      temp: { label: "Temperature", desc: "Сгладить или заострить финальное распределение перед выбором." },
    },
    presets: {
      default: { label: "По умолчанию", hint: "Lettuce local" },
      unsloth: { label: "Unsloth", hint: "llama.cpp style" },
      focused: { label: "Фокусированный", hint: "Жёсткая обрезка" },
      creative: { label: "Креативный", hint: "Поздний фильтр" },
    },
  },
};
