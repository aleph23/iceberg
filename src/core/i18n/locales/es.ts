...
export const esMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  tour: {
    ...
    gotIt: "Entendido",
    appShell: {
      chats: { title: "Aquí viven tus chats", body: "Todas tus conversaciones individuales con personajes están aquí. Vuelve cuando quieras y guardaremos tu lugar." },
      groups: { title: "Chats grupales", body: "Reúne a varios personajes en la misma sala y obsérvalos conversar, o únete tú cuando quieras." },
      discover: { title: "Descubre nuevos personajes", body: "Explora lo que la comunidad ha compartido y añade cualquier personaje que te llame la atención. Nuevos favoritos a un toque de distancia." },
      library: { title: "Tu biblioteca personal", body: "Todo lo que has creado o guardado está aquí: personajes, personas, prompts, todo. Piensa en ello como tu colección." },
      settings: { title: "Personalízalo", body: "Cambia proveedores, elige modelos diferentes, ajusta la apariencia. Prácticamente todo se puede configurar desde los ajustes." },
      search: { title: "Encuentra cualquier cosa, rápido", body: "¿Buscas un chat o personaje específico? Busca en todo desde aquí. Sin necesidad de navegar." },
      create: { title: "Y por último, ¡crea!", body: "Toca el botón de más cuando te llegue la inspiración. Crea un nuevo personaje, persona o empieza algo desde cero." },
    },
    chatDetail: {
      chatTitle: { title: "Ajustes por chat", body: "Toca el nombre del personaje aquí arriba para abrir los ajustes de este chat. Diferentes personas, diseños y modelos por conversación." },
      chatMemory: { title: "Lo que recuerdan", body: "El icono de cerebro muestra lo que tu personaje recuerda de tus conversaciones. Toca para revisar, editar o borrar recuerdos." },
      chatSearch: { title: "Encuentra esa línea", body: "Busca solo en esta conversación. Ideal para encontrar ese detalle de hace 200 mensajes sin desplazarte eternamente." },
      chatLorebook: { title: "Entradas del lorebook", body: "Datos extra, construcción del mundo y contexto que se inyectan en el prompt cuando aparecen palabras clave específicas. La chuleta de tu personaje." },
      chatPlus: { title: "Adjunta cosas", body: "Agrega imágenes o abre el menú de extras. Lo que adjuntes se enviará con tu próximo mensaje." },
      chatComposer: { title: "Tu mensaje, tu turno", body: "Escribe aquí. Enter envía, Shift+Enter añade una nueva línea. Consejo: mantén pulsado cualquier mensaje del chat para editarlo, bifurcarlo o eliminarlo." },
      chatSend: { title: "Un botón, cuatro funciones", body: "El botón de envío cambia su función según lo que esté pasando:" },
    },
    postFirstMessage: {
      chatRegenerate: { title: "¿No te gusta? Regenera", body: "Toca el icono de actualizar para obtener una respuesta completamente nueva del personaje. Cada regeneración se guarda como una variante que puedes revisar." },
      chatVariants: { title: "Desliza entre variantes", body: "Después de regenerar, verás un contador de variantes debajo del mensaje. Desliza a la izquierda o derecha en la burbuja del mensaje para ver las diferentes respuestas." },
      chatLongPress: { title: "Hay más oculto aquí", body: "Mantén pulsado cualquier mensaje para editar, copiar, bifurcar, fijar, eliminar o retroceder la conversación. Clic derecho también funciona en escritorio." },
    },
    sendButton: {
      continue: { label: "Continuar", desc: "Campo vacío. Tocar aquí animará al personaje a seguir hablando." },
      send: { label: "Enviar", desc: "Has escrito o adjuntado algo. Toca para enviarlo." },
      sending: { label: "Enviando", desc: "La respuesta está en camino. Botón bloqueado." },
      stop: { label: "Detener", desc: "Toca para cancelar a mitad de respuesta si cambias de opinión." },
    },
  },
  ...
  samplerOrder: {
    ...
    stages: {
      penalties: { label: "Penalizaciones", desc: "Aplicar penalizaciones de frecuencia y presencia antes del filtrado." },
      grammar: { label: "Gramática", desc: "Restringir tokens cuando una gramática de plantilla de chat nativa está activa." },
      topK: { label: "Top K", desc: "Recortar el grupo de candidatos a los tokens más fuertes." },
      topP: { label: "Top P", desc: "Aplicar filtrado de núcleo a la distribución restante." },
      minP: { label: "Min P", desc: "Eliminar tokens de baja probabilidad usando un umbral mínimo." },
      typical: { label: "Typical P", desc: "Preferir tokens estadísticamente típicos en la distribución actual." },
      temp: { label: "Temperature", desc: "Aplanar o agudizar la distribución final antes de la selección." },
    },
    presets: {
      default: { label: "Predeterminado", hint: "Lettuce local" },
      unsloth: { label: "Unsloth", hint: "Estilo llama.cpp" },
      focused: { label: "Enfocado", hint: "Poda ajustada" },
      creative: { label: "Creativo", hint: "Filtro tardío" },
    },
  },
};
