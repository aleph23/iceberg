...
export const hiMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  chats: {
    ...
    settingsDrawer: { title: "चैट सेटिंग्स", subtitle: "बातचीत की प्राथमिकताएँ प्रबंधित करें" },
  },
  ...
  developer: {
    ...
    onboarding: { title: "ऑनबोर्डिंग", resetTours: "सभी गाइडेड टूर रीसेट करें", resetToursDesc: "हर ऑनबोर्डिंग टूर की देखी गई स्थिति साफ़ करता है ताकि वे अगली विज़िट पर फिर चलें।" },
    benchmarks: {
  ...
  tour: {
    stepCounter: "चरण {{current}} / {{total}}", skipTour: "टूर छोड़ें", next: "अगला", gotIt: "समझ गया",
    appShell: {
      chats: { title: "यहाँ आपकी चैट रहती हैं", body: "कैरेक्टर के साथ आपकी सभी एक-एक बातचीत यहाँ हैं। कभी भी वापस आएँ और हम आपकी जगह याद रखेंगे।" },
      groups: { title: "ग्रुप चैट में शामिल हों", body: "कई कैरेक्टर को एक ही कमरे में लाएँ और उन्हें एक-दूसरे से बात करते देखें, या जब चाहें खुद भी शामिल हों।" },
      discover: { title: "नए कैरेक्टर खोजें", body: "कम्यूनिटी ने जो शेयर किया है उसे ब्राउज़ करें और कोई भी कैरेक्टर जो पसंद आए, ले आएँ। नए पसंदीदा बस एक टैप दूर हैं।" },
      library: { title: "आपकी निजी लाइब्रेरी", body: "आपने जो भी बनाया या सेव किया है वो यहाँ है: कैरेक्टर, पर्सोना, प्रॉम्प्ट, सब कुछ। इसे अपना स्टैश समझें।" },
      settings: { title: "इसे अपना बनाएँ", body: "प्रदाता बदलें, अलग मॉडल चुनें, ऐप का लुक ट्वीक करें। लगभग सब कुछ सेटिंग्स से एडजस्ट हो सकता है।" },
      search: { title: "कुछ भी तेज़ी से खोजें", body: "किसी खास चैट या कैरेक्टर की तलाश है? यहाँ से सब कुछ खोजें। कोई खोजबीन नहीं।" },
      create: { title: "और आखिर में, बनाएँ!", body: "जब भी प्रेरणा मिले प्लस पर टैप करें। नया कैरेक्टर, पर्सोना बनाएँ या शुरू से कुछ शुरू करें।" },
    },
    chatDetail: {
      chatTitle: { title: "प्रति-चैट सेटिंग्स", body: "कैरेक्टर का नाम ऊपर टैप करें इस चैट की सेटिंग्स खोलने के लिए। हर बातचीत के लिए अलग पर्सोना, लेआउट और मॉडल।" },
      chatMemory: { title: "वो क्या याद रखते हैं", body: "ब्रेन आइकन दिखाता है कि आपका कैरेक्टर आपकी बातचीत से क्या याद रखता है। समीक्षा, संपादन या यादें साफ़ करने के लिए टैप करें।" },
      chatSearch: { title: "वो एक लाइन खोजें", body: "सिर्फ इस बातचीत में खोजें। 200 मैसेज पहले की कोई बात ढूँढने के लिए बढ़िया, बिना अंतहीन स्क्रॉलिंग के।" },
      chatLorebook: { title: "लोरबुक एंट्री", body: "अतिरिक्त तथ्य, वर्ल्ड-बिल्डिंग और संदर्भ जो विशिष्ट कीवर्ड आने पर प्रॉम्प्ट में इंजेक्ट होते हैं। आपके कैरेक्टर का चीट शीट।" },
      chatPlus: { title: "चीज़ें अटैच करें", body: "इमेज डालें या एक्स्ट्रा मेनू खोलें। जो भी अटैच करेंगे वो आपके अगले मैसेज के साथ भेजा जाएगा।" },
      chatComposer: { title: "आपका मैसेज, आपकी चाल", body: "यहाँ टाइप करें। Enter भेजता है, Shift+Enter नई लाइन। सुझाव: किसी भी मैसेज पर लॉन्ग-प्रेस करें एडिट, ब्रांच या डिलीट के लिए।" },
      chatSend: { title: "एक बटन, चार काम", body: "सेंड बटन स्थिति के अनुसार अपना काम बदलता है:" },
    },
    postFirstMessage: {
      chatRegenerate: { title: "पसंद नहीं आया? रीजनरेट करें", body: "कैरेक्टर से बिल्कुल नया जवाब पाने के लिए रिफ्रेश आइकन टैप करें। हर रीजनरेशन एक वैरिएंट के रूप में सेव होता है।" },
      chatVariants: { title: "वैरिएंट के बीच स्वाइप करें", body: "रीजनरेट करने के बाद, मैसेज के नीचे वैरिएंट काउंटर दिखेगा। सभी अलग-अलग जवाब देखने के लिए मैसेज बबल पर बाएँ या दाएँ स्वाइप करें।" },
      chatLongPress: { title: "यहाँ और भी छिपा है", body: "किसी भी मैसेज पर लॉन्ग-प्रेस करें एडिट, कॉपी, ब्रांच, पिन, डिलीट या रिवाइंड के लिए। डेस्कटॉप पर राइट-क्लिक भी काम करता है।" },
    },
    sendButton: {
      continue: { label: "जारी रखें", desc: "इनपुट खाली है। टैप करने पर कैरेक्टर बोलता रहेगा।" },
      send: { label: "भेजें", desc: "आपने कुछ टाइप या अटैच किया है। भेजने के लिए टैप करें।" },
      sending: { label: "भेजा जा रहा है", desc: "जवाब आ रहा है। बटन लॉक है।" },
      stop: { label: "रोकें", desc: "जवाब के बीच में रद्द करने के लिए टैप करें।" },
    },
  },

  sessionAdvanced: {
    title: "सत्र पैरामीटर", subtitle: "इस बातचीत के लिए मॉडल डिफ़ॉल्ट ओवरराइड करें",
    goBack: "वापस जाएँ", support: "सहायता", reset: "रीसेट", save: "सहेजें",
    noSessionWarning: "प्रति-सत्र सेटिंग्स कॉन्फ़िगर करने के लिए एक चैट सत्र खोलें।",
    overrideDefaults: "डिफ़ॉल्ट ओवरराइड करें", overrideDefaultsDesc: "सिर्फ इस बातचीत के लिए पैरामीटर कस्टमाइज़ करें",
    loadingContextInfo: "कॉन्टेक्स्ट जानकारी लोड हो रही है...",
    sampling: { title: "सैम्पलिंग", temperature: "Temperature", temperatureDesc: "रैंडमनेस नियंत्रित करता है। कम = अधिक निर्धारित, अधिक = अधिक रचनात्मक।", temperaturePrecise: "सटीक", temperatureCreative: "रचनात्मक", topP: "Top P", topPDesc: "Nucleus sampling। टोकन को संचयी संभावना तक सीमित करता है।", topPFocused: "केंद्रित", topPDiverse: "विविध", topK: "Top K", topKDesc: "सैम्पलिंग को शीर्ष K सबसे संभावित टोकन तक सीमित करता है।" },
    outputPenalties: { title: "आउटपुट और पेनल्टी", maxOutputTokens: "अधिकतम आउटपुट टोकन", maxOutputTokensDesc: "अधिकतम जवाब लंबाई। Auto मॉडल को तय करने देता है।", auto: "Auto", custom: "कस्टम", frequencyPenalty: "फ्रीक्वेंसी पेनल्टी", frequencyPenaltyDesc: "टोकन अनुक्रमों की पुनरावृत्ति कम करता है।", frequencyPenaltyRepeat: "दोहराव", frequencyPenaltyVary: "विविधता", presencePenalty: "प्रेज़ेंस पेनल्टी", presencePenaltyDesc: "नए विषयों की खोज प्रोत्साहित करता है।", presencePenaltyRepeat: "दोहराव", presencePenaltyExplore: "अन्वेषण" },
    performance: { title: "प्रदर्शन", gpuLayers: "GPU Layers", gpuLayersDesc: "GPU पर ऑफलोड की गई लेयर। 0 = केवल CPU।", threads: "Threads", threadsDesc: "इन्फरेंस के लिए CPU threads।", batchThreads: "Batch Threads", batchThreadsDesc: "बैच प्रोसेसिंग के लिए CPU threads।", batchSize: "Batch Size", batchSizeDesc: "प्रॉम्प्ट प्रोसेसिंग चंक साइज़।", contextLength: "कॉन्टेक्स्ट लंबाई", contextLengthDesc: "कॉन्टेक्स्ट विंडो साइज़ ओवरराइड करें।", flashAttention: "Flash Attention", flashAttentionDesc: "GPU मेमोरी ऑप्टिमाइज़ेशन।", enabled: "सक्रिय", disabled: "निष्क्रिय" },
    samplingMemory: { title: "सैम्पलिंग और मेमोरी", minP: "Min P", minPDesc: "न्यूनतम संभावना सीमा।", typicalP: "Typical P", typicalPDesc: "टिपिकल सैम्पलिंग सीमा।", seed: "Seed", seedDesc: "रैंडम seed। रैंडम के लिए खाली छोड़ें।", ropeBase: "RoPE Base", ropeBaseDesc: "फ्रीक्वेंसी बेस ओवरराइड।", ropeScale: "RoPE Scale", ropeScaleDesc: "फ्रीक्वेंसी स्केल ओवरराइड।", kvCacheType: "KV Cache Type", kvCacheTypeDesc: "VRAM बचाने के लिए KV cache क्वांटाइज़ करें।", offloadKqv: "Offload KQV", offloadKqvDesc: "KV cache और KQV ऑप्स GPU पर।", on: "चालू", off: "बंद", samplerProfile: "सैम्पलर प्रोफ़ाइल", samplerProfileDesc: "स्थिरता या तर्क के लिए ट्यून किए गए डिफ़ॉल्ट।", balanced: "संतुलित", creative: "रचनात्मक", stable: "स्थिर", reasoning: "तर्क" },
    systemInfo: { title: "सिस्टम जानकारी", maxContext: "अधिकतम कॉन्टेक्स्ट", recommended: "अनुशंसित", availableRam: "उपलब्ध RAM", availableVram: "उपलब्ध VRAM", modelSize: "मॉडल साइज़" },
  },

  exportMenu: {
    title: "एक्सपोर्ट फ़ॉर्मेट", selectFormat: "फ़ॉर्मेट चुनें", uscTitle: "Unified System Card",
    formats: { uscPrompt: "प्रॉम्प्ट टेम्पलेट के लिए पोर्टेबल USC एक्सपोर्ट।", uscLorebook: "लोरबुक के लिए पोर्टेबल USC एक्सपोर्ट।", uscModel: "मॉडल प्रोफ़ाइल के लिए पोर्टेबल USC एक्सपोर्ट।", uscChatTemplate: "चैट टेम्पलेट के लिए पोर्टेबल USC एक्सपोर्ट।", legacyPromptJson: "Legacy Prompt JSON", legacyPromptJsonDesc: "वर्तमान बाहरी प्रॉम्प्ट पैक फ़ॉर्मेट।", lorebookJson: "Lorebook JSON", lorebookJsonDesc: "वर्तमान लोरबुक एक्सपोर्ट फ़ॉर्मेट।", modelJson: "Model JSON", modelJsonDesc: "क्रेडेंशियल के बिना सुरक्षित मॉडल प्रोफ़ाइल JSON।", chatTemplateJson: "Chat Template JSON", chatTemplateJsonDesc: "नेटिव चैट टेम्पलेट एक्सपोर्ट फ़ॉर्मेट।" },
  },

  designReference: {
    title: "डिज़ाइन संदर्भ", description: "कुछ स्पष्ट संदर्भ इमेज और एक कैनोनिकल विज़ुअल विवरण अपलोड करें।",
    descriptionPlaceholder: "स्थिर लुक का वर्णन करें: चेहरा, बाल, शरीर, उम्र प्रस्तुति, पोशाक संकेत, एक्सेसरीज़ और आर्ट/स्टाइल दिशा।",
    addReferences: "संदर्भ जोड़ें", visualDescription: "विज़ुअल विवरण", draftWithAi: "AI से ड्राफ्ट करें",
    referenceImages: "संदर्भ इमेज", imageAlt: "डिज़ाइन संदर्भ {{index}}", loading: "लोड हो रहा है...",
    removeAria: "डिज़ाइन संदर्भ हटाएँ", noImages: "अभी तक कोई संदर्भ इमेज नहीं",
    ...
    draftMenuTitle: "AI डिज़ाइन ड्राफ्ट", draftMenuDesc: "वर्तमान अवतार और संदर्भ इमेज से {{model}} द्वारा ड्राफ्ट किया गया।",
    draftMenuNoWriter: "इस सहायक का उपयोग करने से पहले एक संगत सीन राइटर मॉडल जोड़ें।",
    regenerate: "पुन: जनरेट करें", useThis: "यह उपयोग करें",
  },

  samplerOrder: {
    title: "सैम्पलर क्रम", description: "चरणों को पुनर्व्यवस्थित करने के लिए खींचें। ऊपर से नीचे निष्पादित होता है।",
    reset: "रीसेट", resetAria: "सैम्पलर क्रम को डिफ़ॉल्ट पर रीसेट करें",
    stages: {
      penalties: { label: "पेनल्टी", desc: "फ़िल्टरिंग से पहले फ्रीक्वेंसी और प्रेज़ेंस पेनल्टी लागू करें।" },
      grammar: { label: "व्याकरण", desc: "नेटिव चैट टेम्पलेट व्याकरण सक्रिय होने पर टोकन सीमित करें।" },
      topK: { label: "Top K", desc: "उम्मीदवार पूल को सबसे मजबूत टोकन तक काटें।" },
      topP: { label: "Top P", desc: "शेष वितरण पर न्यूक्लियस फ़िल्टरिंग लागू करें।" },
      minP: { label: "Min P", desc: "न्यूनतम सीमा का उपयोग करके कम-संभावना वाले टेल टोकन हटाएँ।" },
      typical: { label: "Typical P", desc: "वर्तमान वितरण में सांख्यिकीय रूप से विशिष्ट टोकन पसंद करें।" },
      temp: { label: "Temperature", desc: "चयन से पहले अंतिम वितरण को समतल या तेज़ करें।" },
    },
    presets: {
      default: { label: "डिफ़ॉल्ट", hint: "Lettuce local" },
      unsloth: { label: "Unsloth", hint: "llama.cpp style" },
      focused: { label: "केंद्रित", hint: "कड़ी छँटाई" },
      creative: { label: "रचनात्मक", hint: "देर से फ़िल्टर" },
    },
  },
};
