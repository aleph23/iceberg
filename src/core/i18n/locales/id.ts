...
export const idMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  exportMenu: {
    title: "Format Ekspor", selectFormat: "Pilih format", uscTitle: "Unified System Card",
    formats: { uscPrompt: "Ekspor USC portabel untuk template prompt.", uscLorebook: "Ekspor USC portabel untuk lorebook.", uscModel: "Ekspor USC portabel untuk profil model.", uscChatTemplate: "Ekspor USC portabel untuk template obrolan.", legacyPromptJson: "Legacy Prompt JSON", legacyPromptJsonDesc: "Format paket prompt eksternal saat ini.", lorebookJson: "Lorebook JSON", lorebookJsonDesc: "Format ekspor lorebook saat ini.", modelJson: "Model JSON", modelJsonDesc: "JSON profil model yang aman tanpa kredensial.", chatTemplateJson: "Template Obrolan JSON", chatTemplateJsonDesc: "Format ekspor template obrolan bawaan." },
  },
