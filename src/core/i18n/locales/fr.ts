...
export const frMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  tour: {
    ...
    gotIt: "Compris",
    appShell: {
      chats: { title: "Vos discussions sont ici", body: "Toutes vos conversations individuelles avec les personnages se trouvent ici. Revenez quand vous voulez, on garde votre place." },
      groups: { title: "Discussions de groupe", body: "Réunissez plusieurs personnages dans la même salle et regardez-les discuter, ou rejoignez-les quand vous le souhaitez." },
      discover: { title: "Découvrez de nouveaux personnages", body: "Parcourez ce que la communauté a partagé et ajoutez tout personnage qui vous plaît. De nouveaux favoris à portée de main." },
      library: { title: "Votre bibliothèque personnelle", body: "Tout ce que vous avez créé ou sauvegardé est ici : personnages, personas, prompts, tout. Considérez-la comme votre collection." },
      settings: { title: "Personnalisez", body: "Changez de fournisseur, choisissez différents modèles, ajustez l'apparence. Pratiquement tout est configurable depuis les paramètres." },
      search: { title: "Trouvez n'importe quoi, vite", body: "Vous cherchez un chat ou un personnage précis ? Recherchez partout depuis ici. Pas besoin de fouiller." },
      create: { title: "Et enfin, créez !", body: "Appuyez sur le plus quand l'inspiration frappe. Créez un nouveau personnage, une persona ou commencez quelque chose de zéro." },
    },
    chatDetail: {
      chatTitle: { title: "Paramètres par chat", body: "Appuyez sur le nom du personnage ici pour ouvrir les paramètres de ce chat. Différentes personas, mises en page et modèles par conversation." },
      chatMemory: { title: "Ce dont ils se souviennent", body: "L'icône de cerveau montre ce que votre personnage retient de vos conversations. Appuyez pour consulter, modifier ou effacer les souvenirs." },
      chatSearch: { title: "Trouvez cette réplique", body: "Recherchez uniquement dans cette conversation. Idéal pour retrouver ce détail d'il y a 200 messages sans défiler éternellement." },
      chatLorebook: { title: "Entrées du lorebook", body: "Faits supplémentaires, construction du monde et contexte injectés dans le prompt lorsque des mots-clés spécifiques apparaissent. L'aide-mémoire de votre personnage." },
      chatPlus: { title: "Joindre des éléments", body: "Ajoutez des images ou ouvrez le menu des extras. Ce que vous joignez sera envoyé avec votre prochain message." },
      chatComposer: { title: "Votre message, à vous de jouer", body: "Tapez ici. Entrée envoie, Maj+Entrée ajoute une nouvelle ligne. Astuce : appuyez longuement sur n'importe quel message pour le modifier, le brancher ou le supprimer." },
      chatSend: { title: "Un bouton, quatre fonctions", body: "Le bouton d'envoi change de fonction selon ce qui se passe :" },
    },
    postFirstMessage: {
      chatRegenerate: { title: "Pas satisfait ? Régénérez", body: "Appuyez sur l'icône d'actualisation pour obtenir une réponse complètement nouvelle du personnage. Chaque régénération est sauvegardée comme une variante que vous pouvez revisiter." },
      chatVariants: { title: "Glissez entre les variantes", body: "Après avoir régénéré, vous verrez un compteur de variantes sous le message. Glissez à gauche ou à droite sur la bulle pour parcourir les différentes réponses." },
      chatLongPress: { title: "Il y a plus caché ici", body: "Appuyez longuement sur n'importe quel message pour modifier, copier, brancher, épingler, supprimer ou rembobiner la conversation. Le clic droit fonctionne aussi sur bureau." },
    },
    sendButton: {
      continue: { label: "Continuer", desc: "Champ vide. Appuyer ici encouragera le personnage à continuer de parler." },
      send: { label: "Envoyer", desc: "Vous avez tapé ou joint quelque chose. Appuyez pour envoyer." },
      sending: { label: "Envoi", desc: "La réponse est en chemin. Bouton verrouillé." },
      stop: { label: "Arrêter", desc: "Appuyez pour annuler en cours de réponse si vous changez d'avis." },
    },
  },
  ...
  samplerOrder: {
    ...
    stages: {
      penalties: { label: "Pénalités", desc: "Appliquer les pénalités de fréquence et de présence avant le filtrage." },
      grammar: { label: "Grammaire", desc: "Contraindre les tokens lorsqu'une grammaire de modèle de chat natif est active." },
      topK: { label: "Top K", desc: "Réduire le pool de candidats aux tokens les plus forts." },
      topP: { label: "Top P", desc: "Appliquer le filtrage par noyau à la distribution restante." },
      minP: { label: "Min P", desc: "Éliminer les tokens de faible probabilité avec un seuil minimum." },
      typical: { label: "Typical P", desc: "Préférer les tokens statistiquement typiques dans la distribution actuelle." },
      temp: { label: "Temperature", desc: "Aplatir ou affiner la distribution finale avant la sélection." },
    },
    presets: {
      default: { label: "Par défaut", hint: "Lettuce local" },
      unsloth: { label: "Unsloth", hint: "Style llama.cpp" },
      focused: { label: "Concentré", hint: "Élagage serré" },
      creative: { label: "Créatif", hint: "Filtre tardif" },
    },
  },
};
