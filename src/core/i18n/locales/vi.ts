...
export const viMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  chats: {
    ...
    settingsDrawer: { title: "Cài đặt trò chuyện", subtitle: "Quản lý tùy chọn cuộc trò chuyện" },
  },
  ...
  developer: {
    ...
    onboarding: { title: "Giới thiệu", resetTours: "Đặt lại tất cả hướng dẫn", resetToursDesc: "Xóa trạng thái đã xem của mọi hướng dẫn onboarding để chúng phát lại ở lần truy cập tiếp theo." },
    benchmarks: {
  ...
  tour: {
    stepCounter: "Bước {{current}} / {{total}}", skipTour: "Bỏ qua hướng dẫn", next: "Tiếp", gotIt: "Đã hiểu",
    appShell: {
      chats: { title: "Đây là nơi các cuộc trò chuyện sống", body: "Tất cả cuộc trò chuyện riêng của bạn với nhân vật đều ở đây. Quay lại bất cứ lúc nào và chúng tôi sẽ giữ chỗ cho bạn." },
      groups: { title: "Trò chuyện nhóm", body: "Đưa nhiều nhân vật vào cùng phòng và xem họ nói chuyện với nhau, hoặc tham gia bất cứ khi nào bạn muốn." },
      discover: { title: "Khám phá nhân vật mới", body: "Duyệt qua những gì cộng đồng đã chia sẻ và lấy bất kỳ nhân vật nào bạn thích. Yêu thích mới chỉ cách một chạm." },
      library: { title: "Thư viện cá nhân", body: "Mọi thứ bạn đã tạo hoặc lưu đều ở đây: nhân vật, persona, prompt, tất tần tật. Hãy coi đây là kho của bạn." },
      settings: { title: "Tùy chỉnh theo ý bạn", body: "Đổi nhà cung cấp, chọn mô hình khác, điều chỉnh giao diện. Hầu hết mọi thứ đều có thể điều chỉnh từ cài đặt." },
      search: { title: "Tìm mọi thứ, nhanh chóng", body: "Đang tìm một cuộc trò chuyện hay nhân vật cụ thể? Tìm kiếm mọi thứ từ đây. Không cần đào bới." },
      create: { title: "Và cuối cùng, hãy tạo!", body: "Nhấn dấu cộng khi cảm hứng đến. Tạo nhân vật mới, persona, hoặc bắt đầu từ đầu." },
    },
    chatDetail: {
      chatTitle: { title: "Cài đặt riêng từng cuộc trò chuyện", body: "Nhấn tên nhân vật ở trên để mở cài đặt chỉ cho cuộc trò chuyện này. Persona, bố cục và mô hình khác nhau cho mỗi cuộc trò chuyện." },
      chatMemory: { title: "Họ nhớ gì", body: "Biểu tượng não cho thấy nhân vật nhớ gì về cuộc trò chuyện của bạn. Nhấn để xem lại, chỉnh sửa hoặc xóa ký ức." },
      chatSearch: { title: "Tìm dòng đó", body: "Tìm kiếm chỉ trong cuộc trò chuyện này. Tuyệt vời để tìm chi tiết từ 200 tin nhắn trước mà không cần cuộn mãi." },
      chatLorebook: { title: "Mục lorebook", body: "Thông tin bổ sung, xây dựng thế giới và ngữ cảnh được đưa vào prompt khi xuất hiện từ khóa cụ thể. Bảng ghi chú của nhân vật." },
      chatPlus: { title: "Đính kèm", body: "Thả hình ảnh hoặc mở menu bổ sung. Bất cứ thứ gì đính kèm sẽ được gửi cùng tin nhắn tiếp theo." },
      chatComposer: { title: "Tin nhắn của bạn", body: "Gõ tại đây. Enter gửi, Shift+Enter xuống dòng. Mẹo: nhấn giữ bất kỳ tin nhắn nào để chỉnh sửa, rẽ nhánh hoặc xóa." },
      chatSend: { title: "Một nút, bốn việc", body: "Nút gửi thay đổi chức năng tùy theo tình huống:" },
    },
    postFirstMessage: {
      chatRegenerate: { title: "Không hài lòng? Tạo lại", body: "Nhấn biểu tượng làm mới để nhận câu trả lời hoàn toàn mới từ nhân vật. Mỗi lần tạo lại được lưu như một biến thể." },
      chatVariants: { title: "Vuốt giữa các biến thể", body: "Sau khi tạo lại, bạn sẽ thấy bộ đếm biến thể bên dưới tin nhắn. Vuốt trái hoặc phải trên bong bóng tin nhắn để xem tất cả các câu trả lời khác nhau." },
      chatLongPress: { title: "Còn nhiều thứ ẩn ở đây", body: "Nhấn giữ bất kỳ tin nhắn nào để chỉnh sửa, sao chép, rẽ nhánh, ghim, xóa hoặc tua lại cuộc trò chuyện. Nhấp chuột phải cũng hoạt động trên desktop." },
    },
    sendButton: {
      continue: { label: "Tiếp tục", desc: "Ô nhập trống. Nhấn để nhân vật tiếp tục nói." },
      send: { label: "Gửi", desc: "Bạn đã gõ hoặc đính kèm nội dung. Nhấn để gửi." },
      sending: { label: "Đang gửi", desc: "Câu trả lời đang đến. Nút bị khóa." },
      stop: { label: "Dừng", desc: "Nhấn để hủy giữa chừng nếu bạn đổi ý." },
    },
  },

  sessionAdvanced: {
    title: "Tham số phiên", subtitle: "Ghi đè mặc định mô hình cho cuộc trò chuyện này",
    goBack: "Quay lại", support: "Hỗ trợ", reset: "Đặt lại", save: "Lưu",
    noSessionWarning: "Mở phiên trò chuyện để cấu hình cài đặt riêng từng phiên.",
    overrideDefaults: "Ghi đè mặc định", overrideDefaultsDesc: "Tùy chỉnh tham số chỉ cho cuộc trò chuyện này",
    loadingContextInfo: "Đang tải thông tin ngữ cảnh...",
    sampling: { title: "Lấy mẫu", temperature: "Temperature", temperatureDesc: "Kiểm soát tính ngẫu nhiên. Thấp hơn = xác định hơn, cao hơn = sáng tạo hơn.", temperaturePrecise: "Chính xác", temperatureCreative: "Sáng tạo", topP: "Top P", topPDesc: "Nucleus sampling. Giới hạn token theo xác suất tích lũy.", topPFocused: "Tập trung", topPDiverse: "Đa dạng", topK: "Top K", topKDesc: "Giới hạn lấy mẫu ở top K token có xác suất cao nhất." },
    outputPenalties: { title: "Đầu ra & Phạt", maxOutputTokens: "Token đầu ra tối đa", maxOutputTokensDesc: "Độ dài phản hồi tối đa. Auto để mô hình tự quyết.", auto: "Auto", custom: "Tùy chỉnh", frequencyPenalty: "Phạt tần suất", frequencyPenaltyDesc: "Giảm lặp lại chuỗi token.", frequencyPenaltyRepeat: "Lặp lại", frequencyPenaltyVary: "Đa dạng", presencePenalty: "Phạt hiện diện", presencePenaltyDesc: "Khuyến khích khám phá chủ đề mới.", presencePenaltyRepeat: "Lặp lại", presencePenaltyExplore: "Khám phá" },
    performance: { title: "Hiệu suất", gpuLayers: "GPU Layers", gpuLayersDesc: "Lớp chuyển sang GPU. 0 = chỉ CPU.", threads: "Threads", threadsDesc: "CPU threads cho suy luận.", batchThreads: "Batch Threads", batchThreadsDesc: "CPU threads cho xử lý batch.", batchSize: "Batch Size", batchSizeDesc: "Kích thước khối xử lý prompt.", contextLength: "Độ dài ngữ cảnh", contextLengthDesc: "Ghi đè kích thước cửa sổ ngữ cảnh.", flashAttention: "Flash Attention", flashAttentionDesc: "Tối ưu bộ nhớ GPU.", enabled: "Bật", disabled: "Tắt" },
    samplingMemory: { title: "Lấy mẫu & Bộ nhớ", minP: "Min P", minPDesc: "Ngưỡng xác suất tối thiểu.", typicalP: "Typical P", typicalPDesc: "Ngưỡng lấy mẫu điển hình.", seed: "Seed", seedDesc: "Seed ngẫu nhiên. Để trống cho ngẫu nhiên.", ropeBase: "RoPE Base", ropeBaseDesc: "Ghi đè cơ sở tần số.", ropeScale: "RoPE Scale", ropeScaleDesc: "Ghi đè tỷ lệ tần số.", kvCacheType: "KV Cache Type", kvCacheTypeDesc: "Lượng tử hóa KV cache để tiết kiệm VRAM.", offloadKqv: "Offload KQV", offloadKqvDesc: "KV cache & KQV ops trên GPU.", on: "Bật", off: "Tắt", samplerProfile: "Hồ sơ bộ lấy mẫu", samplerProfileDesc: "Mặc định được tinh chỉnh cho ổn định hoặc suy luận.", balanced: "Cân bằng", creative: "Sáng tạo", stable: "Ổn định", reasoning: "Suy luận" },
    systemInfo: { title: "Thông tin hệ thống", maxContext: "Ngữ cảnh tối đa", recommended: "Khuyến nghị", availableRam: "RAM khả dụng", availableVram: "VRAM khả dụng", modelSize: "Kích thước mô hình" },
  },

  exportMenu: {
    title: "Định dạng xuất", selectFormat: "Chọn định dạng", uscTitle: "Unified System Card",
    formats: { uscPrompt: "Xuất USC di động cho template prompt.", uscLorebook: "Xuất USC di động cho lorebook.", uscModel: "Xuất USC di động cho hồ sơ mô hình.", uscChatTemplate: "Xuất USC di động cho template trò chuyện.", legacyPromptJson: "Legacy Prompt JSON", legacyPromptJsonDesc: "Định dạng gói prompt ngoài hiện tại.", lorebookJson: "Lorebook JSON", lorebookJsonDesc: "Định dạng xuất lorebook hiện tại.", modelJson: "Model JSON", modelJsonDesc: "JSON hồ sơ mô hình an toàn không có thông tin đăng nhập.", chatTemplateJson: "Chat Template JSON", chatTemplateJsonDesc: "Định dạng xuất template trò chuyện gốc." },
  },

  designReference: {
    title: "Tham chiếu thiết kế", description: "Tải lên vài ảnh tham chiếu rõ ràng cùng một mô tả hình ảnh chuẩn.",
    descriptionPlaceholder: "Mô tả diện mạo ổn định: khuôn mặt, tóc, thể hình, tuổi, trang phục, phụ kiện và hướng phong cách.",
    addReferences: "Thêm tham chiếu", visualDescription: "Mô tả hình ảnh", draftWithAi: "Phác thảo với AI",
    referenceImages: "Ảnh tham chiếu", imageAlt: "Tham chiếu thiết kế {{index}}", loading: "Đang tải...",
    removeAria: "Xóa tham chiếu thiết kế", noImages: "Chưa có ảnh tham chiếu nào",
    ...
    draftMenuTitle: "Phác thảo AI", draftMenuDesc: "Phác thảo bởi {{model}} từ avatar và ảnh tham chiếu hiện tại.",
    draftMenuNoWriter: "Thêm mô hình scene writer tương thích trước khi sử dụng trợ giúp này.",
    regenerate: "Tạo lại", useThis: "Dùng cái này",
  },

  samplerOrder: {
    title: "Thứ tự bộ lấy mẫu", description: "Kéo các giai đoạn để sắp xếp lại. Thực thi từ trên xuống dưới.",
    reset: "Đặt lại", resetAria: "Đặt lại thứ tự bộ lấy mẫu về mặc định",
    stages: {
      penalties: { label: "Phạt", desc: "Áp dụng phạt tần suất và hiện diện trước khi lọc." },
      grammar: { label: "Ngữ pháp", desc: "Ràng buộc token khi ngữ pháp template trò chuyện gốc đang hoạt động." },
      topK: { label: "Top K", desc: "Cắt giảm nhóm ứng viên xuống các token mạnh nhất." },
      topP: { label: "Top P", desc: "Áp dụng lọc nucleus cho phân phối còn lại." },
      minP: { label: "Min P", desc: "Loại bỏ token đuôi xác suất thấp bằng ngưỡng tối thiểu." },
      typical: { label: "Typical P", desc: "Ưu tiên token thống kê điển hình trong phân phối hiện tại." },
      temp: { label: "Temperature", desc: "Làm phẳng hoặc làm sắc phân phối cuối cùng trước khi chọn." },
    },
    presets: {
      default: { label: "Mặc định", hint: "Lettuce local" },
      unsloth: { label: "Unsloth", hint: "llama.cpp style" },
      focused: { label: "Tập trung", hint: "Cắt tỉa chặt" },
      creative: { label: "Sáng tạo", hint: "Lọc muộn" },
    },
  },
};
