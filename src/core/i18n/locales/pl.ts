...
export const plMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  tour: {
    ...
    gotIt: "Rozumiem",
    appShell: {
      chats: { title: "Tu mieszkają Twoje czaty", body: "Wszystkie Twoje rozmowy jeden na jeden z postaciami są tutaj. Wróć kiedy chcesz, a zachowamy Twoje miejsce." },
      groups: { title: "Czaty grupowe", body: "Zbierz wiele postaci w jednym pokoju i obserwuj, jak rozmawiają, lub dołącz sam, kiedy masz ochotę." },
      discover: { title: "Odkryj nowe postacie", body: "Przeglądaj to, czym podzieliła się społeczność, i dodaj dowolną postać, która Ci się spodoba. Nowi ulubieńcy na wyciągnięcie ręki." },
      library: { title: "Twoja osobista biblioteka", body: "Wszystko, co stworzyłeś lub zapisałeś, jest tutaj: postacie, persony, prompty, wszystko. Pomyśl o tym jak o swojej kolekcji." },
      settings: { title: "Dostosuj do siebie", body: "Zmieniaj dostawców, wybieraj modele, dostosowuj wygląd. Praktycznie wszystko można konfigurować w ustawieniach." },
      search: { title: "Znajdź cokolwiek, szybko", body: "Szukasz konkretnego czatu lub postaci? Przeszukuj wszystko stąd. Bez przekopywania." },
      create: { title: "I na koniec, twórz!", body: "Stuknij plus, gdy przyjdzie inspiracja. Stwórz nową postać, personę lub zacznij coś od zera." },
    },
    chatDetail: {
      chatTitle: { title: "Ustawienia per czat", body: "Stuknij nazwę postaci u góry, aby otworzyć ustawienia tego czatu. Różne persony, układy i modele na rozmowę." },
      chatMemory: { title: "Co pamiętają", body: "Ikona mózgu pokazuje, co Twoja postać pamięta z waszych rozmów. Stuknij, aby przejrzeć, edytować lub wyczyścić wspomnienia." },
      chatSearch: { title: "Znajdź tę jedną linijkę", body: "Szukaj tylko w tej rozmowie. Świetne do odnalezienia szczegółu sprzed 200 wiadomości bez wiecznego przewijania." },
      chatLorebook: { title: "Wpisy lorebooka", body: "Dodatkowe fakty, budowanie świata i kontekst wstrzykiwane do promptu, gdy pojawiają się określone słowa kluczowe. Ściągawka Twojej postaci." },
      chatPlus: { title: "Załącz rzeczy", body: "Dodaj obrazy lub otwórz menu dodatków. To, co załączysz, zostanie wysłane z następną wiadomością." },
      chatComposer: { title: "Twoja wiadomość, Twój ruch", body: "Pisz tutaj. Enter wysyła, Shift+Enter dodaje nową linię. Wskazówka: przytrzymaj dowolną wiadomość w czacie, aby ją edytować, rozgałęzić lub usunąć." },
      chatSend: { title: "Jeden przycisk, cztery zadania", body: "Przycisk wysyłania zmienia swoje zadanie w zależności od tego, co się dzieje:" },
    },
    postFirstMessage: {
      chatRegenerate: { title: "Nie podoba się? Regeneruj", body: "Stuknij ikonę odświeżania, aby uzyskać zupełnie nową odpowiedź od postaci. Każda regeneracja jest zapisywana jako wariant, do którego możesz wrócić." },
      chatVariants: { title: "Przesuń między wariantami", body: "Po regeneracji zobaczysz licznik wariantów pod wiadomością. Przesuń w lewo lub w prawo na dymku wiadomości, aby przeglądać różne odpowiedzi." },
      chatLongPress: { title: "Tu jest więcej ukrytych opcji", body: "Przytrzymaj dowolną wiadomość, aby edytować, kopiować, rozgałęzić, przypiąć, usunąć lub cofnąć rozmowę. Na komputerze działa też prawy przycisk myszy." },
    },
    sendButton: {
      continue: { label: "Kontynuuj", desc: "Pole puste. Stuknięcie zachęci postać do dalszego mówienia." },
      send: { label: "Wyślij", desc: "Wpisałeś tekst lub załączyłeś coś. Stuknij, aby wysłać." },
      sending: { label: "Wysyłanie", desc: "Odpowiedź jest w drodze. Przycisk zablokowany." },
      stop: { label: "Zatrzymaj", desc: "Stuknij, aby anulować w trakcie odpowiedzi, jeśli zmienisz zdanie." },
    },
  },
  ...
  samplerOrder: {
    ...
    stages: {
      penalties: { label: "Kary", desc: "Zastosuj kary częstotliwości i obecności przed filtrowaniem." },
      grammar: { label: "Gramatyka", desc: "Ogranicz tokeny, gdy natywna gramatyka szablonu czatu jest aktywna." },
      topK: { label: "Top K", desc: "Przytnij pulę kandydatów do najsilniejszych tokenów." },
      topP: { label: "Top P", desc: "Zastosuj filtrowanie jądrowe do pozostałego rozkładu." },
      minP: { label: "Min P", desc: "Odrzuć tokeny o niskim prawdopodobieństwie używając minimalnego progu." },
      typical: { label: "Typical P", desc: "Preferuj statystycznie typowe tokeny w bieżącym rozkładzie." },
      temp: { label: "Temperature", desc: "Spłaszcz lub wyostrz końcowy rozkład przed selekcją." },
    },
    presets: {
      default: { label: "Domyślny", hint: "Lettuce local" },
      unsloth: { label: "Unsloth", hint: "Styl llama.cpp" },
      focused: { label: "Skupiony", hint: "Ciasne przycinanie" },
      creative: { label: "Kreatywny", hint: "Późny filtr" },
    },
  },
};
