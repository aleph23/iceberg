...
export const elMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  chats: {
    ...
    settingsDrawer: { title: "Ρυθμίσεις Συνομιλίας", subtitle: "Διαχείριση προτιμήσεων συνομιλίας" },
  },
  ...
  developer: {
    ...
    onboarding: { title: "Εισαγωγή", resetTours: "Επαναφορά όλων των ξεναγήσεων", resetToursDesc: "Καθαρίζει την κατάσταση για κάθε ξενάγηση εισαγωγής ώστε να ξαναπαίξει στην επόμενη επίσκεψη." },
    benchmarks: {
  ...
  tour: {
    stepCounter: "Βήμα {{current}} από {{total}}", skipTour: "Παράλειψη ξενάγησης", next: "Επόμενο", gotIt: "Κατάλαβα",
    appShell: {
      chats: { title: "Εδώ ζουν οι συνομιλίες σας", body: "Όλες οι συνομιλίες σας ένας-προς-ένας με χαρακτήρες βρίσκονται εδώ. Επιστρέψτε ανά πάσα στιγμή και θα κρατήσουμε τη θέση σας." },
      groups: { title: "Ομαδικές συνομιλίες", body: "Φέρτε πολλούς χαρακτήρες στο ίδιο δωμάτιο και παρακολουθήστε τους να μιλούν μεταξύ τους, ή μπείτε κι εσείς όποτε θέλετε." },
      discover: { title: "Ανακαλύψτε νέους χαρακτήρες", body: "Περιηγηθείτε σε ό,τι έχει μοιραστεί η κοινότητα και φέρτε οποιονδήποτε χαρακτήρα σας τραβήξει το μάτι. Νέα αγαπημένα με ένα πάτημα." },
      library: { title: "Η προσωπική σας βιβλιοθήκη", body: "Ό,τι έχετε φτιάξει ή αποθηκεύσει ζει εδώ: χαρακτήρες, περσόνες, prompts, τα πάντα. Σκεφτείτε το ως την αποθήκη σας." },
      settings: { title: "Κάντε το δικό σας", body: "Αλλάξτε παρόχους, επιλέξτε διαφορετικά μοντέλα, ρυθμίστε την εμφάνιση της εφαρμογής. Σχεδόν τα πάντα είναι ρυθμιζόμενα." },
      search: { title: "Βρείτε ό,τι θέλετε, γρήγορα", body: "Ψάχνετε κάποια συγκεκριμένη συνομιλία ή χαρακτήρα; Αναζητήστε σε όλα από εδώ. Χωρίς σκάψιμο." },
      create: { title: "Και τέλος, δημιουργήστε!", body: "Πατήστε το συν όποτε έρθει έμπνευση. Φτιάξτε νέο χαρακτήρα, περσόνα ή ξεκινήστε κάτι από την αρχή." },
    },
    chatDetail: {
      chatTitle: { title: "Ρυθμίσεις ανά συνομιλία", body: "Πατήστε το όνομα του χαρακτήρα εδώ πάνω για να ανοίξετε ρυθμίσεις μόνο για αυτή τη συνομιλία. Διαφορετικές περσόνες, διατάξεις και μοντέλα ανά συνομιλία." },
      chatMemory: { title: "Τι θυμούνται", body: "Το εικονίδιο εγκεφάλου δείχνει τι θυμάται ο χαρακτήρας από τις συνομιλίες σας. Πατήστε για έλεγχο, επεξεργασία ή εκκαθάριση αναμνήσεων." },
      chatSearch: { title: "Βρείτε εκείνη τη γραμμή", body: "Αναζήτηση μόνο σε αυτή τη συνομιλία. Ιδανικό για να βρείτε μια λεπτομέρεια 200 μηνύματα πίσω χωρίς ατέρμονο scrolling." },
      chatLorebook: { title: "Καταχωρήσεις βιβλίου γνώσης", body: "Επιπλέον πληροφορίες, world-building και πλαίσιο που εισάγονται στο prompt όταν εμφανίζονται συγκεκριμένες λέξεις-κλειδιά. Το σκονάκι του χαρακτήρα σας." },
      chatPlus: { title: "Επισυνάψτε πράγματα", body: "Ρίξτε εικόνες ή ανοίξτε το μενού πρόσθετων. Ό,τι επισυνάψετε στέλνεται μαζί με το επόμενο μήνυμά σας." },
      chatComposer: { title: "Το μήνυμά σας, η κίνησή σας", body: "Πληκτρολογήστε εδώ. Enter στέλνει, Shift+Enter αλλάζει γραμμή. Συμβουλή: πατήστε παρατεταμένα οποιοδήποτε μήνυμα για επεξεργασία, διακλάδωση ή διαγραφή." },
      chatSend: { title: "Ένα κουμπί, τέσσερις δουλειές", body: "Το κουμπί αποστολής αλλάζει λειτουργία ανάλογα με τι συμβαίνει:" },
    },
    postFirstMessage: {
      chatRegenerate: { title: "Δεν σας αρέσει; Αναδημιουργήστε", body: "Πατήστε το εικονίδιο ανανέωσης για μια εντελώς νέα απάντηση από τον χαρακτήρα. Κάθε αναδημιουργία αποθηκεύεται ως παραλλαγή." },
      chatVariants: { title: "Σύρετε μεταξύ παραλλαγών", body: "Μετά την αναδημιουργία, θα δείτε έναν μετρητή παραλλαγών κάτω από το μήνυμα. Σύρετε αριστερά ή δεξιά στο μήνυμα για να δείτε όλες τις διαφορετικές απαντήσεις." },
      chatLongPress: { title: "Κρύβεται κι άλλο εδώ", body: "Πατήστε παρατεταμένα οποιοδήποτε μήνυμα για επεξεργασία, αντιγραφή, διακλάδωση, καρφίτσωμα, διαγραφή ή επαναφορά. Δεξί κλικ λειτουργεί επίσης στην επιφάνεια εργασίας." },
    },
    sendButton: {
      continue: { label: "Συνέχεια", desc: "Η εισαγωγή είναι κενή. Πατήστε για να ενθαρρύνετε τον χαρακτήρα να συνεχίσει." },
      send: { label: "Αποστολή", desc: "Έχετε πληκτρολογήσει ή επισυνάψει κάτι. Πατήστε για αποστολή." },
      sending: { label: "Αποστέλλεται", desc: "Η απάντηση είναι καθ' οδόν. Το κουμπί είναι κλειδωμένο." },
      stop: { label: "Διακοπή", desc: "Πατήστε για ακύρωση αν αλλάξετε γνώμη κατά τη διάρκεια της απάντησης." },
    },
  },

  sessionAdvanced: {
    title: "Παράμετροι Συνεδρίας", subtitle: "Παράκαμψη προεπιλογών μοντέλου για αυτή τη συνομιλία",
    goBack: "Πίσω", support: "Υποστήριξη", reset: "Επαναφορά", save: "Αποθήκευση",
    noSessionWarning: "Ανοίξτε μια συνεδρία συνομιλίας για να ρυθμίσετε τις παραμέτρους ανά συνεδρία.",
    overrideDefaults: "Παράκαμψη προεπιλογών", overrideDefaultsDesc: "Προσαρμόστε παραμέτρους μόνο για αυτή τη συνομιλία",
    loadingContextInfo: "Φόρτωση πληροφοριών πλαισίου...",
    sampling: { title: "Δειγματοληψία", temperature: "Temperature", temperatureDesc: "Ελέγχει την τυχαιότητα. Χαμηλότερο = πιο ντετερμινιστικό, υψηλότερο = πιο δημιουργικό.", temperaturePrecise: "Ακριβές", temperatureCreative: "Δημιουργικό", topP: "Top P", topPDesc: "Nucleus sampling. Περιορίζει τα tokens σε αθροιστική πιθανότητα.", topPFocused: "Εστιασμένο", topPDiverse: "Ποικίλο", topK: "Top K", topKDesc: "Περιορίζει τη δειγματοληψία στα top K πιο πιθανά tokens." },
    outputPenalties: { title: "Έξοδος & Ποινές", maxOutputTokens: "Μέγιστα Tokens Εξόδου", maxOutputTokensDesc: "Μέγιστο μήκος απάντησης. Auto αφήνει το μοντέλο να αποφασίσει.", auto: "Auto", custom: "Προσαρμοσμένο", frequencyPenalty: "Ποινή Συχνότητας", frequencyPenaltyDesc: "Μειώνει την επανάληψη ακολουθιών tokens.", frequencyPenaltyRepeat: "Επανάληψη", frequencyPenaltyVary: "Ποικιλία", presencePenalty: "Ποινή Παρουσίας", presencePenaltyDesc: "Ενθαρρύνει την εξερεύνηση νέων θεμάτων.", presencePenaltyRepeat: "Επανάληψη", presencePenaltyExplore: "Εξερεύνηση" },
    performance: { title: "Απόδοση", gpuLayers: "GPU Layers", gpuLayersDesc: "Επίπεδα που μεταφορτώνονται στη GPU. 0 = μόνο CPU.", threads: "Threads", threadsDesc: "CPU threads για εξαγωγή συμπερασμάτων.", batchThreads: "Batch Threads", batchThreadsDesc: "CPU threads για μαζική επεξεργασία.", batchSize: "Batch Size", batchSizeDesc: "Μέγεθος τμήματος επεξεργασίας prompt.", contextLength: "Μήκος Πλαισίου", contextLengthDesc: "Παράκαμψη μεγέθους παραθύρου πλαισίου.", flashAttention: "Flash Attention", flashAttentionDesc: "Βελτιστοποίηση μνήμης GPU.", enabled: "Ενεργό", disabled: "Ανενεργό" },
    samplingMemory: { title: "Δειγματοληψία & Μνήμη", minP: "Min P", minPDesc: "Κατώτατο όριο πιθανότητας.", typicalP: "Typical P", typicalPDesc: "Τυπικό κατώτατο δειγματοληψίας.", seed: "Seed", seedDesc: "Τυχαίο seed. Αφήστε κενό για τυχαίο.", ropeBase: "RoPE Base", ropeBaseDesc: "Παράκαμψη βάσης συχνότητας.", ropeScale: "RoPE Scale", ropeScaleDesc: "Παράκαμψη κλίμακας συχνότητας.", kvCacheType: "KV Cache Type", kvCacheTypeDesc: "Κβαντοποίηση KV cache για εξοικονόμηση VRAM.", offloadKqv: "Offload KQV", offloadKqvDesc: "KV cache & KQV λειτουργίες στη GPU.", on: "Ενεργό", off: "Ανενεργό", samplerProfile: "Προφίλ Δειγματολήπτη", samplerProfileDesc: "Ρυθμισμένες προεπιλογές για σταθερότητα ή συλλογισμό.", balanced: "Ισορροπημένο", creative: "Δημιουργικό", stable: "Σταθερό", reasoning: "Συλλογισμός" },
    systemInfo: { title: "Πληροφορίες Συστήματος", maxContext: "Μέγιστο Πλαίσιο", recommended: "Συνιστώμενο", availableRam: "Διαθέσιμη RAM", availableVram: "Διαθέσιμη VRAM", modelSize: "Μέγεθος Μοντέλου" },
  },

  exportMenu: {
    title: "Μορφή Εξαγωγής", selectFormat: "Επιλέξτε μορφή", uscTitle: "Unified System Card",
    formats: { uscPrompt: "Φορητή εξαγωγή USC για πρότυπα prompt.", uscLorebook: "Φορητή εξαγωγή USC για βιβλία γνώσης.", uscModel: "Φορητή εξαγωγή USC για προφίλ μοντέλων.", uscChatTemplate: "Φορητή εξαγωγή USC για πρότυπα συνομιλίας.", legacyPromptJson: "Legacy Prompt JSON", legacyPromptJsonDesc: "Τρέχουσα μορφή εξωτερικού πακέτου prompt.", lorebookJson: "Lorebook JSON", lorebookJsonDesc: "Τρέχουσα μορφή εξαγωγής βιβλίου γνώσης.", modelJson: "Model JSON", modelJsonDesc: "Ασφαλές JSON προφίλ μοντέλου χωρίς διαπιστευτήρια.", chatTemplateJson: "Chat Template JSON", chatTemplateJsonDesc: "Εγγενής μορφή εξαγωγής προτύπου συνομιλίας." },
  },

  designReference: {
    title: "Αναφορές σχεδίου", description: "Ανεβάστε μερικές καθαρές εικόνες αναφοράς και μία κανονική οπτική περιγραφή.",
    ...
    addReferences: "Προσθήκη αναφορών", visualDescription: "Οπτική περιγραφή", draftWithAi: "Σχέδιο με AI",
    referenceImages: "Εικόνες αναφοράς", imageAlt: "Αναφορά σχεδίου {{index}}", loading: "Φόρτωση...",
    removeAria: "Αφαίρεση αναφοράς σχεδίου", noImages: "Δεν υπάρχουν εικόνες αναφοράς ακόμα",
    ...
    draftMenuTitle: "Σχέδιο AI", draftMenuDesc: "Σχεδιάστηκε από {{model}} από το τρέχον avatar και τις εικόνες αναφοράς.",
    draftMenuNoWriter: "Προσθέστε ένα συμβατό μοντέλο σεναριογράφου πριν χρησιμοποιήσετε αυτό το βοήθημα.",
    regenerate: "Αναδημιουργία", useThis: "Χρήση Αυτού",
  },

  samplerOrder: {
    title: "Σειρά Δειγματολήπτη", description: "Σύρετε τα στάδια για αναδιάταξη. Εκτελούνται από πάνω προς τα κάτω.",
    reset: "Επαναφορά", resetAria: "Επαναφορά σειράς δειγματολήπτη στις προεπιλογές",
    stages: {
      penalties: { label: "Ποινές", desc: "Εφαρμογή ποινών συχνότητας και παρουσίας πριν το φιλτράρισμα." },
      grammar: { label: "Γραμματική", desc: "Περιορισμός tokens όταν είναι ενεργή η γραμματική προτύπου συνομιλίας." },
      topK: { label: "Top K", desc: "Κόψιμο του πλήθους υποψηφίων στα ισχυρότερα tokens." },
      topP: { label: "Top P", desc: "Εφαρμογή φιλτραρίσματος πυρήνα στην υπολειπόμενη κατανομή." },
      minP: { label: "Min P", desc: "Απόρριψη tokens χαμηλής πιθανότητας με ελάχιστο κατώφλι." },
      typical: { label: "Typical P", desc: "Προτίμηση στατιστικά τυπικών tokens στην τρέχουσα κατανομή." },
      temp: { label: "Temperature", desc: "Ομαλοποίηση ή όξυνση της τελικής κατανομής πριν την επιλογή." },
    },
    presets: {
      default: { label: "Προεπιλογή", hint: "Lettuce local" },
      unsloth: { label: "Unsloth", hint: "llama.cpp style" },
      focused: { label: "Εστιασμένο", hint: "Αυστηρό κλάδεμα" },
      creative: { label: "Δημιουργικό", hint: "Καθυστερημένο φίλτρο" },
    },
  },
};
