...
export const itMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  chats: {
    ...
    settingsDrawer: { title: "Impostazioni chat", subtitle: "Gestisci le preferenze della conversazione" },
  },
  ...
  developer: {
    ...
    onboarding: { title: "Onboarding", resetTours: "Reimposta tutti i tour guidati", resetToursDesc: "Cancella lo stato di visualizzazione di ogni tour di onboarding in modo che vengano riprodotti alla prossima visita." },
    benchmarks: {
  ...
  tour: {
    stepCounter: "Passo {{current}} di {{total}}", skipTour: "Salta il tour", next: "Avanti", gotIt: "Capito",
    appShell: {
      chats: { title: "Qui vivono le tue chat", body: "Tutte le tue conversazioni uno a uno con i personaggi sono qui. Torna quando vuoi e manterremo il tuo posto." },
      groups: { title: "Chatta in gruppo", body: "Porta più personaggi nella stessa stanza e guardali parlare tra loro, oppure unisciti tu stesso quando vuoi." },
      discover: { title: "Scopri nuovi personaggi", body: "Esplora ciò che la community ha condiviso e prendi qualsiasi personaggio ti colpisca. Nuovi preferiti a portata di tap." },
      library: { title: "La tua libreria personale", body: "Tutto ciò che hai creato o salvato vive qui: personaggi, persona, prompt, tutto. Pensalo come il tuo archivio." },
      settings: { title: "Personalizzalo", body: "Cambia provider, scegli modelli diversi, modifica l'aspetto dell'app. Praticamente tutto è regolabile dalle impostazioni." },
      search: { title: "Trova tutto, velocemente", body: "Cerchi una chat o un personaggio specifico? Cerca ovunque da qui. Niente ricerche complicate." },
      create: { title: "E infine, crea!", body: "Tocca il più quando l'ispirazione colpisce. Crea un nuovo personaggio, persona o inizia qualcosa da zero." },
    },
    chatDetail: {
      chatTitle: { title: "Impostazioni per chat", body: "Tocca il nome del personaggio qui sopra per aprire le impostazioni solo per questa chat. Persona, layout e modelli diversi per conversazione." },
      chatMemory: { title: "Cosa ricordano", body: "L'icona del cervello mostra cosa il tuo personaggio ricorda delle vostre conversazioni. Tocca per rivedere, modificare o cancellare i ricordi." },
      chatSearch: { title: "Trova quella frase", body: "Cerca solo in questa conversazione. Perfetto per trovare quel dettaglio di 200 messaggi fa senza scorrere all'infinito." },
      chatLorebook: { title: "Voci del lorebook", body: "Fatti extra, world-building e contesto che vengono iniettati nel prompt quando compaiono parole chiave specifiche. Il foglietto del tuo personaggio." },
      chatPlus: { title: "Allega cose", body: "Inserisci immagini o apri il menu extra. Tutto ciò che alleghi viene inviato con il tuo prossimo messaggio." },
      chatComposer: { title: "Il tuo messaggio, la tua mossa", body: "Scrivi qui. Invio invia, Shift+Invio va a capo. Suggerimento: premi a lungo qualsiasi messaggio per modificare, ramificare o eliminare." },
      chatSend: { title: "Un pulsante, quattro funzioni", body: "Il pulsante di invio cambia funzione in base a cosa sta succedendo:" },
    },
    postFirstMessage: {
      chatRegenerate: { title: "Non ti piace? Rigenera", body: "Tocca l'icona di aggiornamento per ottenere una risposta completamente nuova dal personaggio. Ogni rigenerazione viene salvata come variante." },
      chatVariants: { title: "Scorri tra le varianti", body: "Dopo la rigenerazione, vedrai un contatore di varianti sotto il messaggio. Scorri a sinistra o destra sulla bolla del messaggio per sfogliare tutte le risposte diverse." },
      chatLongPress: { title: "C'è di più nascosto qui", body: "Premi a lungo qualsiasi messaggio per modificare, copiare, ramificare, fissare, eliminare o riavvolgere la conversazione. Il clic destro funziona anche su desktop." },
    },
    sendButton: {
      continue: { label: "Continua", desc: "L'input è vuoto. Toccando qui il personaggio continuerà a parlare." },
      send: { label: "Invia", desc: "Hai digitato o allegato qualcosa. Tocca per inviare." },
      sending: { label: "Invio in corso", desc: "La risposta è in arrivo. Il pulsante è bloccato." },
      stop: { label: "Ferma", desc: "Tocca per annullare durante la risposta se cambi idea." },
    },
  },

  sessionAdvanced: {
    title: "Parametri sessione", subtitle: "Sovrascrivi i valori predefiniti del modello per questa conversazione",
    goBack: "Torna indietro", support: "Supporto", reset: "Reimposta", save: "Salva",
    noSessionWarning: "Apri una sessione di chat per configurare le impostazioni per sessione.",
    overrideDefaults: "Sovrascrivi predefiniti", overrideDefaultsDesc: "Personalizza i parametri solo per questa conversazione",
    loadingContextInfo: "Caricamento info contesto...",
    sampling: { title: "Campionamento", temperature: "Temperature", temperatureDesc: "Controlla la casualità. Più basso = più deterministico, più alto = più creativo.", temperaturePrecise: "Preciso", temperatureCreative: "Creativo", topP: "Top P", topPDesc: "Nucleus sampling. Limita i token a una probabilità cumulativa.", topPFocused: "Focalizzato", topPDiverse: "Diverso", topK: "Top K", topKDesc: "Limita il campionamento ai top K token più probabili." },
    outputPenalties: { title: "Output e Penalità", maxOutputTokens: "Token di output massimi", maxOutputTokensDesc: "Lunghezza massima della risposta. Auto lascia decidere al modello.", auto: "Auto", custom: "Personalizzato", frequencyPenalty: "Penalità di frequenza", frequencyPenaltyDesc: "Riduce la ripetizione di sequenze di token.", frequencyPenaltyRepeat: "Ripetizione", frequencyPenaltyVary: "Variazione", presencePenalty: "Penalità di presenza", presencePenaltyDesc: "Incoraggia l'esplorazione di nuovi argomenti.", presencePenaltyRepeat: "Ripetizione", presencePenaltyExplore: "Esplorazione" },
    performance: { title: "Prestazioni", gpuLayers: "GPU Layers", gpuLayersDesc: "Livelli scaricati sulla GPU. 0 = solo CPU.", threads: "Threads", threadsDesc: "Thread CPU per l'inferenza.", batchThreads: "Batch Threads", batchThreadsDesc: "Thread CPU per l'elaborazione batch.", batchSize: "Batch Size", batchSizeDesc: "Dimensione chunk elaborazione prompt.", contextLength: "Lunghezza contesto", contextLengthDesc: "Sovrascrivi dimensione finestra di contesto.", flashAttention: "Flash Attention", flashAttentionDesc: "Ottimizzazione memoria GPU.", enabled: "Abilitato", disabled: "Disabilitato" },
    samplingMemory: { title: "Campionamento e Memoria", minP: "Min P", minPDesc: "Soglia minima di probabilità.", typicalP: "Typical P", typicalPDesc: "Soglia campionamento tipico.", seed: "Seed", seedDesc: "Seed casuale. Lascia vuoto per casuale.", ropeBase: "RoPE Base", ropeBaseDesc: "Override base frequenza.", ropeScale: "RoPE Scale", ropeScaleDesc: "Override scala frequenza.", kvCacheType: "KV Cache Type", kvCacheTypeDesc: "Quantizza KV cache per risparmiare VRAM.", offloadKqv: "Offload KQV", offloadKqvDesc: "KV cache e operazioni KQV su GPU.", on: "On", off: "Off", samplerProfile: "Profilo campionatore", samplerProfileDesc: "Predefiniti ottimizzati per stabilità o ragionamento.", balanced: "Bilanciato", creative: "Creativo", stable: "Stabile", reasoning: "Ragionamento" },
    systemInfo: { title: "Info di sistema", maxContext: "Contesto massimo", recommended: "Consigliato", availableRam: "RAM disponibile", availableVram: "VRAM disponibile", modelSize: "Dimensione modello" },
  },

  exportMenu: {
    title: "Formato di esportazione", selectFormat: "Seleziona un formato", uscTitle: "Unified System Card",
    formats: { uscPrompt: "Esportazione USC portabile per template di prompt.", uscLorebook: "Esportazione USC portabile per lorebook.", uscModel: "Esportazione USC portabile per profili modello.", uscChatTemplate: "Esportazione USC portabile per template di chat.", legacyPromptJson: "Legacy Prompt JSON", legacyPromptJsonDesc: "Formato attuale pacchetto prompt esterno.", lorebookJson: "Lorebook JSON", lorebookJsonDesc: "Formato attuale esportazione lorebook.", modelJson: "Model JSON", modelJsonDesc: "JSON profilo modello sicuro senza credenziali.", chatTemplateJson: "Chat Template JSON", chatTemplateJsonDesc: "Formato nativo esportazione template di chat." },
  },

  designReference: {
    title: "Riferimenti di design", description: "Carica alcune immagini di riferimento chiare e una descrizione visiva canonica.",
    ...
    addReferences: "Aggiungi riferimenti", visualDescription: "Descrizione visiva", draftWithAi: "Bozza con AI",
    referenceImages: "Immagini di riferimento", imageAlt: "Riferimento di design {{index}}", loading: "Caricamento...",
    removeAria: "Rimuovi riferimento di design", noImages: "Nessuna immagine di riferimento ancora",
    ...
    draftMenuTitle: "Bozza AI Design", draftMenuDesc: "Bozza creata da {{model}} dall'avatar e dalle immagini di riferimento attuali.",
    draftMenuNoWriter: "Aggiungi un modello scene writer compatibile prima di usare questo strumento.",
    regenerate: "Rigenera", useThis: "Usa questo",
  },

  samplerOrder: {
    title: "Ordine campionatore", description: "Trascina gli stadi per riordinare. Eseguiti dall'alto verso il basso.",
    reset: "Reimposta", resetAria: "Reimposta l'ordine del campionatore ai valori predefiniti",
    stages: {
      penalties: { label: "Penalità", desc: "Applica penalità di frequenza e presenza prima del filtraggio." },
      grammar: { label: "Grammatica", desc: "Vincola i token quando è attiva la grammatica del template di chat nativo." },
      topK: { label: "Top K", desc: "Riduce il pool di candidati ai token più forti." },
      topP: { label: "Top P", desc: "Applica il filtraggio nucleus alla distribuzione rimanente." },
      minP: { label: "Min P", desc: "Elimina i token di coda a bassa probabilità usando una soglia minima." },
      typical: { label: "Typical P", desc: "Preferisce token statisticamente tipici nella distribuzione corrente." },
      temp: { label: "Temperature", desc: "Appiattisce o acuisce la distribuzione finale prima della selezione." },
    },
    presets: {
      default: { label: "Predefinito", hint: "Lettuce local" },
      unsloth: { label: "Unsloth", hint: "llama.cpp style" },
      focused: { label: "Focalizzato", hint: "Potatura stretta" },
      creative: { label: "Creativo", hint: "Filtro tardivo" },
    },
  },
};
