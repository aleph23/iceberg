...
export const filMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  tour: {
    ...
    appShell: {
      chats: { title: "Dito nakatira ang mga chat mo", body: "Lahat ng isa-sa-isang usapan mo sa mga karakter ay nandito. Bumalik anumang oras at itatago namin ang pwesto mo." },
      groups: { title: "Makisali sa mga group chat", body: "Dalhin ang maraming karakter sa iisang kwarto at panoorin silang mag-usap, o sumali ka mismo kahit kailan mo gusto." },
      discover: { title: "Humanap ng mga bagong karakter", body: "I-browse ang mga ibinahagi ng komunidad at kunin ang anumang karakter na makuha ang atensyon mo. Isang tap lang ang mga bagong paborito." },
      library: { title: "Ang iyong personal na library", body: "Lahat ng ginawa o na-save mo ay nandito: mga karakter, persona, prompt, lahat-lahat. Isipin mo itong koleksyon mo." },
      settings: { title: "Gawin itong sa iyo", body: "Palitan ang mga provider, pumili ng ibang modelo, i-tweak ang hitsura ng app. Halos lahat ay naaayos mula sa settings." },
      search: { title: "Hanapin ang kahit ano, mabilis", body: "Naghahanap ng partikular na chat o karakter? Maghanap sa lahat mula dito. Walang kailangang maghukay." },
      create: { title: "At sa wakas, gumawa!", body: "I-tap ang plus button kapag may pumasok na inspirasyon. Gumawa ng bagong karakter, persona, o magsimula mula sa wala." },
    },
    chatDetail: {
      chatTitle: { title: "Mga setting per chat", body: "I-tap ang pangalan ng karakter dito sa taas para buksan ang mga setting para sa chat na ito lang. Iba-ibang persona, layout, at model picks kada usapan." },
      chatMemory: { title: "Ang kanilang natatandaan", body: "Ipinapakita ng brain icon kung ano ang natatandaan ng karakter mo tungkol sa mga usapan niyo. I-tap para suriin, i-edit, o burahin ang mga alaala." },
      chatSearch: { title: "Hanapin ang isang linya", body: "Maghanap sa usapang ito lang. Magaling para hanapin ang detalyeng iyon mula sa 200 mensahe na ang nakakaraan nang hindi nagso-scroll nang walang hanggan." },
      chatLorebook: { title: "Mga Lorebook entry", body: "Dagdag na mga katotohanan, world-building, at konteksto na ini-inject sa prompt kapag lumabas ang mga partikular na keyword. Ang cheat sheet ng iyong karakter." },
      chatPlus: { title: "Mag-attach ng mga bagay", body: "Mag-drop ng mga larawan o buksan ang extras menu. Anumang i-attach mo ay kasama sa susunod mong mensahe." },
      chatComposer: { title: "Ang mensahe mo, ang galaw mo", body: "Mag-type dito. Enter ang nagpapadala, Shift+Enter nagdadagdag ng bagong linya. Tip: long-press sa anumang mensahe sa chat para mag-edit, mag-branch, o mag-delete." },
      chatSend: { title: "Isang button, apat na trabaho", body: "Nagbabago ang trabaho ng send button batay sa nangyayari:" },
    },
    postFirstMessage: {
      chatRegenerate: { title: "Hindi masaya? I-regenerate", body: "I-tap ang refresh icon para makakuha ng bagong sagot mula sa karakter. Bawat regeneration ay nase-save bilang variant na maaari mong balikan." },
      chatVariants: { title: "Mag-swipe sa mga variant", body: "Pagkatapos mag-regenerate, makikita mo ang variant counter sa ibaba ng mensahe. Mag-swipe pakaliwa o pakanan sa message bubble para magpalipat-lipat sa lahat ng iba-ibang sagot." },
      chatLongPress: { title: "May nakatago pa dito", body: "Long-press sa anumang mensahe para mag-edit, mag-copy, mag-branch, mag-pin, mag-delete, o mag-rewind ng usapan. Right-click din ang gumagana sa desktop." },
    },
    sendButton: {
      continue: { label: "Magpatuloy", desc: "Walang laman ang input. Ang pag-tap dito ay magpu-push sa karakter na magpatuloy sa pag-uusap." },
      send: { label: "Ipadala", desc: "Nag-type ka o nag-attach ng isang bagay. I-tap para ipadala." },
      sending: { label: "Ipinapadala", desc: "Paparating na ang sagot. Naka-lock ang button." },
      stop: { label: "Ihinto", desc: "I-tap para kanselahin sa gitna ng sagot kung nagbago ang isip mo." },
    },
  },

  sessionAdvanced: {
    title: "Mga Parameter ng Session", subtitle: "I-override ang mga default ng modelo para sa usapang ito",
    goBack: "Bumalik", support: "Suporta", reset: "I-reset", save: "I-save",
    noSessionWarning: "Magbukas ng chat session para i-configure ang mga per-session na setting.",
    overrideDefaults: "I-override ang mga default", overrideDefaultsDesc: "I-customize ang mga parameter para sa usapang ito lang",
    loadingContextInfo: "Naglo-load ng context info...",
    sampling: { title: "Sampling", temperature: "Temperature", temperatureDesc: "Kinokontrol ang randomness. Mas mababa = mas deterministic, mas mataas = mas creative.", temperaturePrecise: "Presiso", temperatureCreative: "Creative", topP: "Top P", topPDesc: "Nucleus sampling. Nililimitahan ang mga token sa cumulative probability.", topPFocused: "Nakatutok", topPDiverse: "Magkakaiba", topK: "Top K", topKDesc: "Nililimitahan ang sampling sa top K pinakamalamang na mga token." },
    outputPenalties: { title: "Output at Parusa", maxOutputTokens: "Max Output Token", maxOutputTokensDesc: "Pinakamahaba ng sagot. Auto hinahayaan ang modelo na magdesisyon.", auto: "Auto", custom: "Custom", frequencyPenalty: "Frequency Penalty", frequencyPenaltyDesc: "Binabawasan ang pag-uulit ng mga token sequence.", frequencyPenaltyRepeat: "Ulitin", frequencyPenaltyVary: "Iba-ibahin", presencePenalty: "Presence Penalty", presencePenaltyDesc: "Hinihikayat na mag-explore ng mga bagong paksa.", presencePenaltyRepeat: "Ulitin", presencePenaltyExplore: "I-explore" },
    performance: { title: "Performance", gpuLayers: "GPU Layer", gpuLayersDesc: "Mga layer na ini-offload sa GPU. 0 = CPU lang.", threads: "Thread", threadsDesc: "CPU thread para sa inference.", batchThreads: "Batch Thread", batchThreadsDesc: "CPU thread para sa batch processing.", batchSize: "Batch Size", batchSizeDesc: "Laki ng chunk sa prompt processing.", contextLength: "Haba ng Context", contextLengthDesc: "I-override ang laki ng context window.", flashAttention: "Flash Attention", flashAttentionDesc: "Pag-optimize ng GPU memory.", enabled: "Naka-enable", disabled: "Naka-disable" },
    samplingMemory: { title: "Sampling at Memory", minP: "Min P", minPDesc: "Minimum probability threshold.", typicalP: "Typical P", typicalPDesc: "Typical sampling threshold.", seed: "Seed", seedDesc: "Random seed. Iwanang blangko para random.", ropeBase: "RoPE Base", ropeBaseDesc: "Frequency base override.", ropeScale: "RoPE Scale", ropeScaleDesc: "Frequency scale override.", kvCacheType: "Uri ng KV Cache", kvCacheTypeDesc: "I-quantize ang KV Cache para makatipid ng VRAM.", offloadKqv: "Offload KQV", offloadKqvDesc: "KV Cache at KQV ops sa GPU.", on: "On", off: "Off", samplerProfile: "Sampler Profile", samplerProfileDesc: "Mga na-tune na default para sa stability o reasoning.", balanced: "Balanse", creative: "Creative", stable: "Stable", reasoning: "Reasoning" },
    systemInfo: { title: "System Info", maxContext: "Max Context", recommended: "Inirerekomenda", availableRam: "Available RAM", availableVram: "Available VRAM", modelSize: "Laki ng Modelo" },
  },

  exportMenu: {
    title: "Format ng Export", selectFormat: "Pumili ng format", uscTitle: "Unified System Card",
    formats: { uscPrompt: "Portable USC export para sa mga prompt template.", uscLorebook: "Portable USC export para sa mga lorebook.", uscModel: "Portable USC export para sa mga model profile.", uscChatTemplate: "Portable USC export para sa mga chat template.", legacyPromptJson: "Legacy Prompt JSON", legacyPromptJsonDesc: "Kasalukuyang external prompt pack format.", lorebookJson: "Lorebook JSON", lorebookJsonDesc: "Kasalukuyang lorebook export format.", modelJson: "Model JSON", modelJsonDesc: "Ligtas na model profile JSON na walang credentials.", chatTemplateJson: "Chat Template JSON", chatTemplateJsonDesc: "Native na chat template export format." },
  },

  designReference: {
    title: "Mga design reference", description: "Mag-upload ng ilang malinaw na reference image at isang canonical na visual description.",
    ...
    addReferences: "Magdagdag ng mga reference", visualDescription: "Visual na paglalarawan", draftWithAi: "I-draft gamit ang AI",
    referenceImages: "Mga reference image", imageAlt: "Design reference {{index}}", loading: "Naglo-load...",
    removeAria: "Alisin ang design reference", noImages: "Wala pang naka-attach na reference image",
    ...
    draftMenuTitle: "AI Design Draft", draftMenuDesc: "Na-draft ng {{model}} mula sa kasalukuyang avatar at mga reference image.",
    draftMenuNoWriter: "Magdagdag ng compatible na scene writer model bago gamitin ang helper na ito.",
    regenerate: "I-regenerate", useThis: "Gamitin Ito",
  },

  samplerOrder: {
    title: "Pagkakasunod-sunod ng Sampler", description: "I-drag ang mga stage para ayusin. Ine-execute mula taas pababa.",
    reset: "I-reset", resetAria: "I-reset ang sampler order sa default",
    stages: {
      penalties: { label: "Mga Parusa", desc: "I-apply ang frequency at presence penalty bago ang filtering." },
      grammar: { label: "Grammar", desc: "Limitahan ang mga token kapag aktibo ang native chat template grammar." },
      topK: { label: "Top K", desc: "I-trim ang candidate pool sa mga pinakamalakas na token." },
      topP: { label: "Top P", desc: "I-apply ang nucleus filtering sa natitirang distribusyon." },
      minP: { label: "Min P", desc: "I-drop ang mababang-probability na tail token gamit ang minimum floor." },
      typical: { label: "Typical P", desc: "Mas piliin ang statistically typical na mga token sa kasalukuyang distribusyon." },
      temp: { label: "Temperature", desc: "Patagin o patulisin ang final distribution bago pumili." },
    },
    presets: {
      default: { label: "Default", hint: "Lettuce local" },
      unsloth: { label: "Unsloth", hint: "estilo ng llama.cpp" },
      focused: { label: "Nakatutok", hint: "Mahigpit na prune" },
      creative: { label: "Creative", hint: "Huling filter" },
    },
  },
};
