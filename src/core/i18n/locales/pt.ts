...
export const ptMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  tour: {
    ...
    gotIt: "Entendi",
    appShell: {
      chats: { title: "Aqui ficam seus chats", body: "Todas as suas conversas individuais com personagens ficam aqui. Volte a qualquer momento e nós guardaremos seu lugar." },
      groups: { title: "Participe de chats em grupo", body: "Traga vários personagens para a mesma sala e veja-os conversando entre si, ou entre na conversa quando quiser." },
      discover: { title: "Descubra novos personagens", body: "Navegue pelo que a comunidade compartilhou e adicione qualquer personagem que chamar sua atenção. Novos favoritos estão a um toque de distância." },
      library: { title: "Sua biblioteca pessoal", body: "Tudo o que você criou ou salvou fica aqui: personagens, personas, prompts, tudo. Pense nisso como seu acervo." },
      settings: { title: "Personalize do seu jeito", body: "Troque provedores, escolha modelos diferentes, ajuste a aparência do app. Praticamente tudo é configurável nas configurações." },
      search: { title: "Encontre qualquer coisa, rápido", body: "Procurando um chat ou personagem específico? Pesquise em tudo daqui mesmo. Sem precisar cavar." },
      create: { title: "E por fim, crie!", body: "Toque no botão de mais sempre que a inspiração surgir. Crie um novo personagem, persona ou comece algo do zero." },
    },
    chatDetail: {
      chatTitle: { title: "Configurações por chat", body: "Toque no nome do personagem aqui em cima para abrir configurações só para este chat. Personas, layouts e modelos diferentes por conversa." },
      chatMemory: { title: "O que eles lembram", body: "O ícone de cérebro mostra o que seu personagem lembra das suas conversas. Toque para revisar, editar ou limpar memórias." },
      chatSearch: { title: "Encontre aquela frase", body: "Pesquise apenas nesta conversa. Ótimo para encontrar aquele detalhe de 200 mensagens atrás sem rolar infinitamente." },
      chatLorebook: { title: "Entradas do Lorebook", body: "Fatos extras, construção de mundo e contexto que são injetados no prompt quando palavras-chave específicas aparecem. A cola do seu personagem." },
      chatPlus: { title: "Anexe coisas", body: "Adicione imagens ou abra o menu de extras. O que você anexar será enviado junto com sua próxima mensagem." },
      chatComposer: { title: "Sua mensagem, sua vez", body: "Digite aqui. Enter envia, Shift+Enter adiciona uma nova linha. Dica: pressione e segure qualquer mensagem no chat para editar, ramificar ou excluir." },
      chatSend: { title: "Um botão, quatro funções", body: "O botão de envio muda sua função dependendo do que está acontecendo:" },
    },
    postFirstMessage: {
      chatRegenerate: { title: "Não gostou? Regenere", body: "Toque no ícone de atualização para obter uma resposta completamente nova do personagem. Cada regeneração é salva como uma variante que você pode revisitar." },
      chatVariants: { title: "Deslize entre variantes", body: "Após regenerar, você verá um contador de variantes abaixo da mensagem. Deslize para a esquerda ou direita na bolha da mensagem para alternar entre todas as respostas diferentes." },
      chatLongPress: { title: "Tem mais escondido aqui", body: "Pressione e segure qualquer mensagem para editar, copiar, ramificar, fixar, excluir ou rebobinar a conversa. Clique com o botão direito também funciona no desktop." },
    },
    sendButton: {
      continue: { label: "Continuar", desc: "Campo vazio. Tocar aqui incentiva o personagem a continuar falando." },
      send: { label: "Enviar", desc: "Você digitou ou anexou algo. Toque para enviar." },
      sending: { label: "Enviando", desc: "A resposta está a caminho. Botão bloqueado." },
      stop: { label: "Parar", desc: "Toque para cancelar a resposta no meio se mudar de ideia." },
    },
  },

  sessionAdvanced: {
    title: "Parâmetros da Sessão", subtitle: "Sobrescrever padrões do modelo para esta conversa",
    goBack: "Voltar", support: "Suporte", reset: "Redefinir", save: "Salvar",
    noSessionWarning: "Abra uma sessão de chat para configurar as configurações por sessão.",
    overrideDefaults: "Sobrescrever padrões", overrideDefaultsDesc: "Personalizar parâmetros apenas para esta conversa",
    loadingContextInfo: "Carregando informações de contexto...",
    sampling: { title: "Amostragem", temperature: "Temperature", temperatureDesc: "Controla a aleatoriedade. Menor = mais determinístico, maior = mais criativo.", temperaturePrecise: "Preciso", temperatureCreative: "Criativo", topP: "Top P", topPDesc: "Amostragem de núcleo. Limita tokens a uma probabilidade cumulativa.", topPFocused: "Focado", topPDiverse: "Diverso", topK: "Top K", topKDesc: "Limita a amostragem aos top K tokens mais prováveis." },
    outputPenalties: { title: "Saída e Penalidades", maxOutputTokens: "Tokens Máximos de Saída", maxOutputTokensDesc: "Comprimento máximo da resposta. Auto deixa o modelo decidir.", auto: "Auto", custom: "Personalizado", frequencyPenalty: "Penalidade de Frequência", frequencyPenaltyDesc: "Reduz repetição de sequências de tokens.", frequencyPenaltyRepeat: "Repetir", frequencyPenaltyVary: "Variar", presencePenalty: "Penalidade de Presença", presencePenaltyDesc: "Incentiva explorar novos tópicos.", presencePenaltyRepeat: "Repetir", presencePenaltyExplore: "Explorar" },
    performance: { title: "Desempenho", gpuLayers: "Camadas GPU", gpuLayersDesc: "Camadas descarregadas na GPU. 0 = apenas CPU.", threads: "Threads", threadsDesc: "Threads de CPU para inferência.", batchThreads: "Threads de Lote", batchThreadsDesc: "Threads de CPU para processamento em lote.", batchSize: "Tamanho do Lote", batchSizeDesc: "Tamanho do bloco de processamento do prompt.", contextLength: "Comprimento do Contexto", contextLengthDesc: "Sobrescrever tamanho da janela de contexto.", flashAttention: "Flash Attention", flashAttentionDesc: "Otimização de memória GPU.", enabled: "Ativado", disabled: "Desativado" },
    samplingMemory: { title: "Amostragem e Memória", minP: "Min P", minPDesc: "Limiar mínimo de probabilidade.", typicalP: "Typical P", typicalPDesc: "Limiar de amostragem típica.", seed: "Seed", seedDesc: "Semente aleatória. Deixe em branco para aleatório.", ropeBase: "RoPE Base", ropeBaseDesc: "Sobrescrita da base de frequência.", ropeScale: "RoPE Scale", ropeScaleDesc: "Sobrescrita da escala de frequência.", kvCacheType: "Tipo de KV Cache", kvCacheTypeDesc: "Quantizar KV Cache para economizar VRAM.", offloadKqv: "Offload KQV", offloadKqvDesc: "KV Cache e operações KQV na GPU.", on: "Ligado", off: "Desligado", samplerProfile: "Perfil do Sampler", samplerProfileDesc: "Padrões ajustados para estabilidade ou raciocínio.", balanced: "Equilibrado", creative: "Criativo", stable: "Estável", reasoning: "Raciocínio" },
    systemInfo: { title: "Informações do Sistema", maxContext: "Contexto Máximo", recommended: "Recomendado", availableRam: "RAM Disponível", availableVram: "VRAM Disponível", modelSize: "Tamanho do Modelo" },
  },

  exportMenu: {
    title: "Formato de Exportação", selectFormat: "Selecione um formato", uscTitle: "Unified System Card",
    formats: { uscPrompt: "Exportação USC portátil para templates de prompt.", uscLorebook: "Exportação USC portátil para lorebooks.", uscModel: "Exportação USC portátil para perfis de modelo.", uscChatTemplate: "Exportação USC portátil para templates de chat.", legacyPromptJson: "Prompt JSON Legado", legacyPromptJsonDesc: "Formato atual de pacote de prompt externo.", lorebookJson: "Lorebook JSON", lorebookJsonDesc: "Formato atual de exportação de lorebook.", modelJson: "Modelo JSON", modelJsonDesc: "JSON seguro de perfil de modelo sem credenciais.", chatTemplateJson: "Template de Chat JSON", chatTemplateJsonDesc: "Formato nativo de exportação de template de chat." },
  },

  designReference: {
    title: "Referências de design", description: "Envie algumas imagens de referência claras e uma descrição visual canônica.",
    ...
    addReferences: "Adicionar referências", visualDescription: "Descrição visual", draftWithAi: "Rascunhar com IA",
    referenceImages: "Imagens de referência", imageAlt: "Referência de design {{index}}", loading: "Carregando...",
    removeAria: "Remover referência de design", noImages: "Nenhuma imagem de referência anexada ainda",
    ...
    draftMenuTitle: "Rascunho de Design com IA", draftMenuDesc: "Rascunhado por {{model}} a partir do avatar e imagens de referência atuais.",
    draftMenuNoWriter: "Adicione um modelo de escritor de cenas compatível antes de usar este assistente.",
    regenerate: "Regenerar", useThis: "Usar Este",
  },

  samplerOrder: {
    title: "Ordem do Sampler", description: "Arraste as etapas para reordenar. Executado de cima para baixo.",
    reset: "Redefinir", resetAria: "Redefinir ordem do sampler para o padrão",
    stages: {
      penalties: { label: "Penalidades", desc: "Aplicar penalidades de frequência e presença antes da filtragem." },
      grammar: { label: "Gramática", desc: "Restringir tokens quando uma gramática nativa de template de chat está ativa." },
      topK: { label: "Top K", desc: "Reduzir o pool de candidatos aos tokens mais fortes." },
      topP: { label: "Top P", desc: "Aplicar filtragem de núcleo à distribuição restante." },
      minP: { label: "Min P", desc: "Descartar tokens de cauda de baixa probabilidade usando um piso mínimo." },
      typical: { label: "Typical P", desc: "Preferir tokens estatisticamente típicos na distribuição atual." },
      temp: { label: "Temperature", desc: "Achatar ou aguçar a distribuição final antes da seleção." },
    },
    presets: {
      default: { label: "Padrão", hint: "Lettuce local" },
      unsloth: { label: "Unsloth", hint: "estilo llama.cpp" },
      focused: { label: "Focado", hint: "Poda restrita" },
      creative: { label: "Criativo", hint: "Filtro tardio" },
    },
  },
};
